...
7. (a) Produce bar plot showing low income household against HOLC grades.
```{r}
#| code-fold: true
#| code-summary: "Show the code" 
...
7. (b) Produce bar plot showing pm 2.5 percentile against HOLC grades.
```{r}
#| code-fold: true
#| code-summary: "Show the code" 
...
7. (c) Produce bar plot showing low life expectancy percentile against HOLC grades.
```{r}
#| code-fold: true
#| code-summary: "Show the code" 
